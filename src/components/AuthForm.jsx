...
export default function AuthForm() {
  ...
  const oauthButtonStyle = {
    ...
    justifyContent: "center", gap: "0.5rem", backgroundColor: "white",
  };
  ...
  return (
    <div>
      ...
      <button
        ...
        style={{ ...oauthButtonStyle, backgroundColor: "#24292e", color: "white", border: "none" }}
      >
      ...
      <div style={{ display: "flex", alignItems: "center", margin: "1rem 0" }}>
        ...
        <span style={{ padding: "0 0.75rem", color: "#999", fontSize: "0.85rem" }}>or</span>
        <hr style={{ flex: 1, border: "none", borderTop: "1px solid #eee" }} />
      </div>
